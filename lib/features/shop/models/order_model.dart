...
class OrderModel {
  ...
  String get formattedOrderDate => SHFHelperFunctions.getFormattedDate(orderDate);

  String get formattedDeliveryDate => deliveryDate != null ? SHFHelperFunctions.getFormattedDate(deliveryDate!) : '';
  ...
  static OrderModel empty() => OrderModel(id: '', items: [], orderDate: DateTime.now(), status: OrderStatus.pending, totalAmount: 0); // Default createdAt to current time
